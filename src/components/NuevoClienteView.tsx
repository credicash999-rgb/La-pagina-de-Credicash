    ...
    <div id="nuevo-cliente-view" className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 tracking-tight">Ficha Única de Nuevo Cliente</h2>
      ...
      {/* Validation Panel */}
      {validationError && (
        <div className="bg-rose-50 border border-rose-200 text-rose-800 p-4 rounded-xl flex items-start gap-3 animate-fadeIn">
      ...
      {phoneWarning && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 p-4 rounded-xl flex items-start gap-3 animate-fadeIn">
      ...
      <form onSubmit={handleOpenSummary} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-semibold text-slate-800"
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">DNI / Cédula *</label>
              <input
                type="text"
                required
                value={dni}
                ...
                onBlur={validateOnTheFly}
                className="w-full px-3.5 py-2 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-semibold text-slate-800 font-mono"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all text-slate-800 font-semibold"
              />
            </div>

            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Edad (Auto-calculada)</label>
              <input
                type="text"
                disabled
                value={edad !== '' ? `${edad} años` : 'Ingrese fecha de nacimiento'}
                className="w-full px-3.5 py-2 bg-slate-100 border border-slate-200 rounded-xl text-sm focus:outline-none text-slate-500 font-semibold"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all text-slate-800 font-semibold cursor-pointer"
              >
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Teléfono Celular */}
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Teléfono Celular *</label>
              <div className="flex rounded-xl border border-slate-200 bg-slate-50 focus-within:ring-2 focus-within:ring-emerald-500/10 focus-within:border-emerald-500 transition-all focus-within:bg-white overflow-hidden">
                <select
                  value={telefonoPrefijo}
                  onChange={(e) => setTelefonoPrefijo(e.target.value)}
                  className="bg-transparent border-r border-slate-200 px-2 py-2 text-xs font-bold text-slate-500 focus:outline-none cursor-pointer shrink-0"
                >
                  <option value="+54 9 11">+54 9 11 (BsAs)</option>
                  <option value="+54 9 351">+54 9 351 (Cba)</option>
                  <option value="+54 9 341">+54 9 341 (Ros)</option>
                  <option value="+54 9 261">+54 9 261 (Mza)</option>
                  <option value="+54 9 381">+54 9 381 (Tuc)</option>
                  <option value="+54 9 342">+54 9 342 (S.Fe)</option>
                  <option value="+54 9 379">+54 9 379 (Corr)</option>
                  <option value="+54 9 387">+54 9 387 (Salta)</option>
                  <option value="+54 9 299">+54 9 299 (Nqn)</option>
                  <option value="+54 9 223">+54 9 223 (Mdp)</option>
                  <option value="+54 9">+54 9 (Otro)</option>
                ...
                <input
                  ...
                  onBlur={validateOnTheFly}
                  className="w-full px-3 py-2 bg-transparent text-sm focus:outline-none font-semibold text-slate-800"
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Teléfono Alternativo (Opcional)</label>
              <div className="flex rounded-xl border border-slate-200 bg-slate-50 focus-within:ring-2 focus-within:ring-emerald-500/10 focus-within:border-emerald-500 transition-all focus-within:bg-white overflow-hidden">
                <select
            ...
            {/* Correo Electrónico */}
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Correo Electrónico (Email)</label>
              <div className="flex rounded-xl border border-slate-200 bg-slate-50 focus-within:ring-2 focus-within:ring-emerald-500/10 focus-within:border-emerald-500 transition-all focus-within:bg-white overflow-hidden items-center px-3.5">
                <Mail className="w-4 h-4 text-slate-400 shrink-0 mr-2" />
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="w-full py-2 bg-transparent text-sm focus:outline-none font-semibold text-slate-800"
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Persona de Referencia</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Teléfono de Referencia</label>
              <div className="flex rounded-xl border border-slate-200 bg-slate-50 focus-within:ring-2 focus-within:ring-emerald-500/10 focus-within:border-emerald-500 transition-all focus-within:bg-white overflow-hidden">
                <select
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Calle *</label>
              <input
                type="text"
                required
                value={calle}
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Barrio *</label>
              <input
                type="text"
                required
                value={barrio}
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Código Postal</label>
              <input
                type="text"
                value={codigoPostal}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Actividad / Profesión</label>
                <input
                  type="text"
                  value={actividad}
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Lugar de Trabajo</label>
                <input
                  type="text"
                  value={lugarTrabajo}
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Antigüedad</label>
                <input
                  type="text"
                  value={antiguedad}
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Ingreso Mensual ($)</label>
                <input
                  type="number"
                  value={ingresos}
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">CBU / CVU / Alias de Cobro</label>
                <input
                  type="text"
                  value={aliasCbu}
              ...
              <div className="md:col-span-2">
                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Banco / Entidad Emisora</label>
                <input
                  type="text"
                  value={banco}
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Captador Asignado *</label>
              <input
                type="text"
                required
                value={captador}
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Analista Asignado *</label>
              <input
                type="text"
                required
                value={analista}
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Estado de Alta Inicial</label>
              <select
                value={estadoCliente}
                onChange={(e) => setEstadoCliente(e.target.value as any)}
                className="w-full px-3.5 py-2 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all text-slate-800 font-semibold cursor-pointer"
              >
                <option value="PROSPECTO">PROSPECTO (En evaluación de perfil)</option>
                <option value="ACTIVO">ACTIVO (Pre-aprobado para otorgar)</option>
                <option value="SUSPENDIDO">SUSPENDIDO (No califica por historial)</option>
                <option value="INACTIVO">INACTIVO</option>
              </select>
            </div>

            <div>
              <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Origen de Captación</label>
              <select
                value={origen}
              ...
              >
                ...
                <option value="REFERIDO">REFERIDO POR TERCEROS</option>
                <option value="PAGINA_WEB">PÁGINA WEB OFICIAL</option>
                <option value="PRESENCIAL">ATENCIÓN PRESENCIAL EN OFICINA</option>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div>
            <textarea
              ...
              className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 focus:bg-white transition-all font-medium text-slate-800"
              rows={3}
        ...
        <div className="flex justify-end gap-3 pt-2">
          <button
            ...
            className="px-6 py-3 border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl font-bold text-xs uppercase tracking-wider transition-all"
          >
            Volver a la Lista
          </button>
          <button
            type="submit"
            className="px-8 py-3 bg-[#1E803B] hover:bg-[#155C2A] text-white rounded-xl font-bold text-xs uppercase tracking-widest transition-all shadow-md hover:shadow-none flex items-center gap-2"
          >
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 space-y-6">
            ...
            <div className="flex justify-between items-start border-b border-slate-100 pb-4">
              <div>
                <h4 className="text-base font-extrabold text-slate-900">Resumen y Validación de Ficha de Cliente</h4>
                <p className="text-[11px] text-slate-500 mt-0.5">Revise meticulosamente el legajo antes de guardarlo de forma definitiva.</p>
              </div>
              <button 
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Nombre y Apellido</span>
                  <span className="font-extrabold text-slate-800 text-sm">{nombre} {apellido}</span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">DNI de Identidad</span>
                  <span className="font-mono font-extrabold text-slate-800 text-sm">{dni}</span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Fecha de Nacimiento / Edad</span>
                  <span className="font-bold text-slate-700">{fechaNacimiento || 'No declarada'} ({edad !== '' ? `${edad} años` : 'N/A'})</span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Sexo</span>
              ...
              <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Celular / WhatsApp</span>
                  <span className="font-bold text-slate-800">
                    {telefonoPrefijo} {telefonoNro} {whatsappNro ? `(WhatsApp: ${whatsappPrefijo} ${whatsappNro})` : ''}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Dirección Unificada</span>
                  <span className="font-bold text-slate-700">{calle} {numero}, Bº {barrio}, {ciudad}, {provincia}</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Actividad e Ingresos</span>
                  <span className="font-bold text-slate-800">{actividad || 'Sin especificar'} ({ingresos ? `$${ingresos.toLocaleString('es-ES')}` : 'Sin ingresos declarados'})</span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Alias / CBU y Banco</span>
                  <span className="font-mono font-bold text-slate-700">{aliasCbu || 'N/A'} ({banco || 'N/A'})</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Asignación Comercial</span>
                  <span className="font-bold text-slate-800">Captador: {captador} | Analista: {analista}</span>
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-slate-400 block mb-0.5">Estado Inicial / Origen</span>
                  <span className="font-bold text-emerald-700">{estadoCliente} / {origen}</span>
                </div>
              </div>
              ...
              <div className="p-4 bg-blue-50/60 border border-blue-100 rounded-xl space-y-1.5 text-blue-800 leading-relaxed">
                <span className="text-[10px] uppercase font-bold block">Campos Computados Automáticamente al Confirmar:</span>
                <ul className="list-disc pl-4 space-y-1 text-[10px] font-medium text-blue-700">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
              <button
                type="button"
                onClick={() => setShowSummaryModal(false)}
                className="px-5 py-2.5 border border-slate-200 text-slate-600 rounded-xl font-bold hover:bg-slate-50 transition-colors text-xs"
              >
                Cancelar
              </button>
              <button
                ...
                className="px-6 py-2.5 bg-emerald-600 text-white font-extrabold rounded-xl hover:bg-emerald-700 transition-colors flex items-center gap-1 text-xs uppercase tracking-wider"
              >
